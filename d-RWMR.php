...
<html lang="es">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-dark bg-dark">
            <h1 class="navbar-brand ps-3">RWMR</h1>
        </nav>
        <div id="layoutSidenav">
            <div id="layoutSidenav_content">
                <main>
                <br>
                <a href="RWMR-A.php"><img class= "img-rwmr" src="img/rwmr1.jpg" alt="Imagen" /></a>
                <br>
                <br>
                <a href="RWMR-C.php"><img class= "img-rwmr" src="img/rwmr3.png" alt="Imagen" /></a>
                <br>
                <br>
                <a href="RWMR-G.php"><img class= "img-rwmr" src="img/rwmr5.jpg" alt="Imagen" /></a>
                <br>
                </main>
            </div>
        </div>
