...
<html lang="es">
    <head>
        ...
        <title>Cambiar contraseña - E.P.E.T. N°5 </title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Recuperar tu contraseña</h3></div>
                                    <div class="card-body">
                                        <div class="small mb-3 text-muted">Ingresá tu correo electrónico y te mandaremos un email para cambiarla.</div>
                                        <form>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                ...
                                                <a class="btn btn-primary" href="login.html">Cambiar contraseña</a>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="register.html">¿No tenés cuenta? Registrate</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
