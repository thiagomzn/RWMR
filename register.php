...
<html lang="es">
    <head>
        ...
        <title>Registrarse - E.P.E.T. N°5</title>
        <link href="css/styles.css" rel="stylesheet" />
        <script src="https://use.fontawesome.com/releases/v6.3.0/js/all.js" crossorigin="anonymous"></script>
    </head>
    <body class="bg-light"> 
        <nav class="sb-topnav navbar navbar-dark bg-dark">
            <h1 class="navbar-brand ps-3">RWMR - Registro</h1>
        </nav>
...
?>
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid">
                                                    <input class="btn btn-primary" type="submit" value="Crear cuenta" name="register">
                                                </div>
                                            </div>
                                        </form>
                                    </div>
